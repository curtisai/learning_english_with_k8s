...
### As said above, namespaces are the keys. Docker is not necessary if you can find a different way to manage the namesapces. Here is an example: https://github.com/p8952/bocker
