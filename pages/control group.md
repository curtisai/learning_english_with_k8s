...
#### Because a task can belong to only a single cgroup in any one hierarchy, there is onlyl one way that a task can be limited or affected by any single subsystem.
